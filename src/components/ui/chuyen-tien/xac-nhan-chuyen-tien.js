...
export default class ScreenXacNhanNapChuyenTien extends React.Component {
        ...
        <View style={styles.box}>
          <View style={styles.inputContainer}>
            <View style={styles.textContainer}>
              ...
              <View style={{marginTop: 7, marginHorizontal: 20}}>
                <Text style={styles.value}>TK-7291.00000.80137</Text>
              </View>
              <View style={{marginVertical: 4, marginHorizontal: 20}}>
                <Text style={styles.description}>DANG MINH TIEN</Text>
              </View>
              <View style={styles.line} />
            </View>
          </View>
        ...
        <View style={styles.box}>
          <View style={styles.inputContainer}>
            <View style={styles.textContainer}>
              ...
              <View style={{marginTop: 7, marginHorizontal: 20}}>
                <Text style={[styles.value, {fontSize: 18}]}>11,000 VND</Text>
              </View>
              <View style={{marginVertical: 4, marginHorizontal: 20}}>
                <Text style={[styles.description, {fontSize: 11}]}>
                  Mười một nghìn đồng
        ...
        <View style={styles.box}>
          <View style={styles.inputContainer}>
            <View style={styles.textContainer}>
              ...
              <View style={{marginVertical: 4, marginHorizontal: 20}}>
                <Text style={[styles.description, {fontSize: 11}]}>
                  Hai triệu năm trăm mười một nghìn đồng
                </Text>
              </View>
              <View style={styles.line} />
            </View>
            ...
            <View style={styles.viewInModal}>
              ...
              <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                ...
                <TouchableHighlight
                  onPress={() => {
                    this.toggleModal();
                    this.props.navigation.push('ChiTietGiaoDichChuyenTien', {
