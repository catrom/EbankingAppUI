...
export default class ScreenXacNhanNapTienDienThoai extends React.Component {
        ...
        <View style={styles.box}>
          <View style={styles.inputContainer}>
            <View style={styles.textContainer}>
              ...
              <View style={{marginTop: 7, marginHorizontal: 20}}>
                <Text style={styles.value}>SDT-038 674 4772</Text>
              </View>
              <View style={{marginVertical: 4, marginHorizontal: 20}}>
            ...
            <View style={styles.viewInModal}>
              ...
              <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                ...
                <TouchableHighlight
                  onPress={() => {
                    this.toggleModal();
                    this.props.navigation.push('ChiTietGiaoDichNapTien', {
